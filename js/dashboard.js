...
sidebarLinks('#reports-link', 'reports.html');
sidebarLinks('#users-link', 'users.html');
sidebarLinks('#admins-link', 'admins.html');
sidebarLinks('#companies-link', 'companies.html');
